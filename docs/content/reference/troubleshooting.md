...
Most of these come down to network reality or how jsinfo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jsinfo rate-limits like any public site. jsinfo already paces
...
Where a surface is gated, jsinfo reads a cookie or token you supply
...
`jsinfo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jsinfo actually did
